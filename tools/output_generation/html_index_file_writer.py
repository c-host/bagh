"""
HTML Index File Writer module for Bagh build process.
Handles writing generated HTML content to the main index.html file in the dist directory.

This module:
1. Writes generated HTML content to index.html in dist directory
...
class HTMLIndexFileWriter:
    """Handles writing HTML content to the main index.html file in the dist directory."""
    ...
    def __init__(self, project_root: Path, config_manager=None):
        ...
        self.output_file = self.config_manager.get_path("index_html")
    ...
    def write_file_with_backup(
        self, content: str, backup_suffix: str = ".backup"
    ) -> bool:
        """
