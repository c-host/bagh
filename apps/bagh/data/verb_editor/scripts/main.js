 ...
 */
    ...
    getVerbsFilePath() {
        ...
        return 'apps/bagh/data/verbs.json';
    }
    ...
    handleExampleGenerationError(tense, error) {
        ...
        if (error.message.includes('fetch') || error.message.includes('NetworkError') ||
            ...
            guidance = 'Using mock examples. To use real examples, start the Python server: python apps/bagh/data/verb_editor/servers/start_all_servers.py';
