...
class VerbEditorGNCIntegration {
    ...
    async autoGenerateRawGlosses(conjugationsData) {
        ...
        try {
            ...
            if (!proxyHealthy) {
                throw new Error("GNC proxy server is not available. Please start it with: python apps/bagh/data/verb_editor/servers/start_gnc_server.py");
            }
