        ...
        try {
            ...
            if (!response.ok) {
                if (response.status === 404) {
                    throw new Error('Python scraper server not found. Please start the scraper server by running: python apps/bagh/data/verb_editor/scripts/scraper_server.py');
